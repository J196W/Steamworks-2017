...
class Record(object):
    def __init__(self):
        ...
        self.frontOut = cv2.VideoWriter(time.strftime("%I-%M-%d") + "-FRONT.mp4", cv2.VideoWriter_fourcc(*'MPEG'), 30, (640, 360))
        self.backOut = cv2.VideoWriter(time.strftime("%I-%M-%d") + "-BACK.mp4", cv2.VideoWriter_fourcc(*'MPEG'), 30, (640, 360))
